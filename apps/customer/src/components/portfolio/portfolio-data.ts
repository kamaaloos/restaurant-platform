...
export const PLATFORM_PRODUCTS: PlatformProduct[] = [
  ...
  },
  {
    ...
    status: "live",
    description:
      "Designed and shipped an offline-first Windows retail POS for small shops—checkout, inventory, staff PINs, sales reports, and in-app update feed.",
    result:
      "A native desktop register teams can run without constant cloud dependency, with a public landing and installer at retail.maylesoft.com.",
    icon: ShoppingCart,
    accent: "#60a5fa",
    tech: ["Flutter", "Dart", "SQLite", "Windows", "Desktop"],
    highlights: [
      "Offline POS",
      "Inventory",
      "Staff PINs",
