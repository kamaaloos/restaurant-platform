...
/** Same streaming table-food scenes as the waiter display. */
const TABLE_SCENES = [
...
export function DiningBackdrop() {
  ...
  return (
    <div
      ...
      aria-hidden
    >
      <div className="admin-bg-drift absolute inset-[-10%]">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-[var(--paper)]/50 via-transparent to-[var(--accent-soft)]/40" />
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_50%_100%,rgba(15,92,76,0.14),transparent_55%)]" />
    </div>
  );
}
